...
public class MarioList {
	...
	public MarioList() {
		...
		imageMap = createImageMap(nameList);// createImageMap = private 메소드임

		JList list = new JList(nameList);
		list.setCellRenderer(new MarioListRenderer());// MarioListRenderer = 메소드{return
														// 컴포넌트(인덱스,isSelected,celHashFocus)}
